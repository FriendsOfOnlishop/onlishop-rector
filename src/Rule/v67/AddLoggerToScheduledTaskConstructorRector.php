...
namespace FriendsOfOnlishop\Rector\Rule\v67;
...
final class AddLoggerToScheduledTaskConstructorRector extends AbstractRector
{
    ...
    {
        if (!$this->isObjectType($node, new ObjectType('Onlishop\Core\Framework\MessageQueue\ScheduledTask\ScheduledTaskHandler'))) {
            return null;
        }
